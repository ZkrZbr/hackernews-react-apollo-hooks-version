...
const LinkList = (props) => {
    ...
    const _updateCacheAfterVote = (store, createVote, linkId) => {
        ...
        data.feed.links[votedLink.id] = votedLink;
    ...
    const { loading, error, data } = useQuery(FEED_QUERY,
        { variables: _getQueryVariables(), fetchPolicy: "cache-first" }); // network-only
...
export const FEED_QUERY_DATA = gql`
  fragment FeedQueryData on Link {
    id
    createdAt
    url
    description
